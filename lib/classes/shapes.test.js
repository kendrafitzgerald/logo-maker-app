...
describe ('Circle', () => {
  describe('render', () => {
    it('should create a circle with a color of blue, text color of white, and text of Hello World', () => {
      ...
      expect(shape.render(text1, textColor1, shapeColor1)).toEqual(`<svg version="1.1"width="300" height="200"xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="40" fill="blue" /><text x="50" y="60" text-anchor="middle" font-family="sans-serif"font-size="30" fill= "white">Hello World</text></svg>`);
      });
  });
});
