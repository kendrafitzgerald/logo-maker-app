    ...
    render(text, textColor, shapeColor) {
        return `<svg version="1.1"
            ...
            <text x="50" y="60" text-anchor="middle" font-family="sans-serif"
             font-size="30" fill= "${textColor}">${text}</text>
...
class Triangle extends Shapes {
    ...
    render (text, textColor, shapeColor) {
        return `<svg version="1.1"
            ...
            <text x="150" y="125" text-anchor="middle" font-family="sans-serif"
            font-size="40" fill= "${textColor}">${text}</text>
...
class Square extends Shapes {
    ...
    render(text, textColor, shapeColor) {
        return `<svg version="1.1" 
            ...
            <text x="125" y="100" dominant-baseline="middle" text-anchor="middle" font-family="sans-serif"
